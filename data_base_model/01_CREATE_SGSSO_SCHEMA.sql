...
IF NOT EXISTS (	SELECT 1 
	...
	BEGIN
		CREATE TABLE [dbo].[Project] (
			project_id			INT CONSTRAINT PK_project PRIMARY KEY NOT NULL,
...
IF NOT EXISTS (	SELECT 1 
	...
	BEGIN
		CREATE TABLE dbo.Item_Equipment(
			item_equipment_id INT CONSTRAINT PK_item_equipment PRIMARY KEY NOT NULL,
...
IF NOT EXISTS (	SELECT 1 
	...
	BEGIN
		CREATE TABLE [dbo].[Employee_Project](
			emp_proj_id	INT CONSTRAINT PK_emp_proj PRIMARY KEY NOT NULL,
...
IF NOT EXISTS (	SELECT 1 
	...
	BEGIN
		CREATE TABLE [dbo].[Assignment_Item_Equipment](
			assignment_item_id INT CONSTRAINT PK_assignment_item PRIMARY KEY NOT NULL,
...
IF NOT EXISTS (	SELECT 1 
	...
	BEGIN
		CREATE TABLE [dbo].[Machinery] (
			machinery_id	INT CONSTRAINT PK_machinary PRIMARY KEY NOT NULL,
...
IF NOT EXISTS (	SELECT 1
	...
	BEGIN
		CREATE TABLE [dbo].[Assignment_Machinery] (
			assignment_machinery_id INT CONSTRAINT PK_assignment_machinery PRIMARY KEY NOT NULL,
